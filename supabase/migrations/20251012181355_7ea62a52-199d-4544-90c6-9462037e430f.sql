-- Fix admin_approve_payment to increment user_offers counter when offer is used
...
BEGIN
  ...
  IF v_reservation_id IS NOT NULL THEN
    ...
    -- Increment offer usage counter if this reservation used an offer
    IF v_offer_id IS NOT NULL THEN
      v_month_year := date_trunc('month', NOW())::date;
      
      INSERT INTO public.user_offers (user_id, offer_id, month_year, used_count)
      VALUES (v_client_id, v_offer_id, v_month_year, 1)
