-- Add friend_code column to payment_requests to track which friend code was used
ALTER TABLE public.payment_requests 
ADD COLUMN IF NOT EXISTS friend_code text;

-- Update admin_approve_payment to mark friend code as used when payment is approved
...
begin
  ...
  if v_res.type = 'subscription_request' then
    ...
    if v_friend_code is not null then
      ...
      RAISE NOTICE 'Marked friend code % as used for user %', v_friend_code, v_client_id;
    end if;
