-- Função RPC para aplicar oferta e criar reserva
...
BEGIN
  ...
  -- Determinar o serviço baseado na oferta
  -- Para "Compre 2h Gravação, Ganhe +1h Grátis" -> usar serviço Captação 2h
  SELECT id INTO v_service_id 
  FROM public.services 
  WHERE slug = 'captacao-2h' AND is_active = true
  LIMIT 1;
