-- Add is_used column to vouchers table
ALTER TABLE public.vouchers ADD COLUMN IF NOT EXISTS is_used boolean NOT NULL DEFAULT false;

-- Update admin_approve_payment function to mark voucher as used
