-- Fix subscribe_request to NOT use a random service but create proper subscription data
...
BEGIN
  ...
  -- Get the first available service ID (just for FK constraint, not used for display)
  ...
  VALUES (
    p_user_id,
    v_reservation_id,
    v_service_name,  -- This is now correctly 'Subscrição Plano S' or 'Subscrição Plano X'
    p_amount_eur,
    0,
    'EUR',
    'pending'
