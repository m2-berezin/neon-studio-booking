...
begin
    ...
    IF v_referee_code_use_id IS NOT NULL AND v_referrer_user_id IS NOT NULL THEN
      ...
      IF NOT v_reward_already_given THEN
        INSERT INTO public.point_transactions (
          ...
          v_referrer_user_id, 2500, 'referral_earned',
          'Recompensa por convite - amigo utilizou GW', v_referee_code_use_id
        );
        ...
        INSERT INTO public.referral_rewards (
          ...
          v_referrer_user_id, 2500, 25, now() + interval '30 days', false, v_referee_code_use_id
        );
        ...
        VALUES (
          v_referrer_user_id, 'user', '💎 Recebeste 2500 GW!',
  ...
  if v_res.type = 'subscription_request' then
    ...
    -- Insert unavailable_slot with overlap merging
